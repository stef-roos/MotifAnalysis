 ...
 */
public class AllUndirectedMotifAnalyzer extends MotifRetriever {

	public AllUndirectedMotifAnalyzer(boolean edgeWeights, boolean nodeWeights) {
		super(8, new int[] {2,3,3,3,4,4,5,6}, new int[]{3,3,4,4,4,4,4,4}, edgeWeights, nodeWeights, false,null);
	}
	
	public AllUndirectedMotifAnalyzer(boolean edgeWeights, boolean nodeWeights, String retrieve) {
		super(8, new int[] {2,3,3,3,4,4,5,6}, new int[]{3,3,4,4,4,4,4,4}, edgeWeights, nodeWeights, true,retrieve);
	}
	
	public AllUndirectedMotifAnalyzer(boolean edgeWeights, boolean nodeWeights, String retrieve, int[] bounds) {
