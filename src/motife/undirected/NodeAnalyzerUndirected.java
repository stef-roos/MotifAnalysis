 ...
 */
public class NodeAnalyzerUndirected extends MotifNodeRetriever {
	//which of the 8 motifs should be analyzed
	//default: all
	private boolean[] motifs;
	
    public NodeAnalyzerUndirected(boolean edgeWeights, boolean nodeWeights, boolean retrieve,
	...
	public NodeAnalyzerUndirected(boolean edgeWeights, boolean nodeWeights,  Node node, boolean[] motifs) {
		super(8,new int[] {2,3,3,3,4,4,5,6}, new int[]{3,3,4,4,4,4,4,4},edgeWeights, nodeWeights, false, null,
				node);
		this.motifs = motifs;
	}
	
	public NodeAnalyzerUndirected(boolean edgeWeights, boolean nodeWeights, Node node) {
		this(edgeWeights,nodeWeights,node, new boolean[]{true, true, true,true,true,true,true,true});
	}
	
	public NodeAnalyzerUndirected(boolean edgeWeights, boolean nodeWeights,  Node node, String file, boolean[] motifs) {
		super(8,new int[] {2,3,3,3,4,4,5,6}, new int[]{3,3,4,4,4,4,4,4},edgeWeights, nodeWeights, true, file,
				node);
		this.motifs = motifs;
	}
	
	public NodeAnalyzerUndirected(boolean edgeWeights, boolean nodeWeights, Node node, String file) {
	...
	public int analyzeMotif(Graph g, int motif) {
		if (motif==1){
	...
	public int analyzeMotif1(Graph g){
		int count = 0;
	...
	public int analyzeMotif2(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors, neighbors2;
		Node[] motifNodes = new Node[3];
	...
	public int analyzeMotif3(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors, neighbors2;
	...
	public int analyzeMotif4(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
	...
	public int analyzeMotif5(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors, neighbors2;
		Node[] motifNodes = new Node[4];
	...
	public int analyzeMotif6(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors, neighbors2;
		Node[] motifNodes = new Node[4];
	...
	public int analyzeMotif7(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors, neighbors2;
		Node[] motifNodes = new Node[4];
	...
	public int analyzeMotif8(Graph g){
		int count = 0;
		Node[] nodes = g.getNodes();
		Edge[] neighbors;
		Node[] motifNodes = new Node[4];
